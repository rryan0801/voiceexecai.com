...
export default function ContentOpportunities({ websiteId }) {
  ...
  const { data: opportunities } = useQuery({
    ...
    queryFn: async () => await seoApi.getContentOpportunities(websiteId)
  });

  const briefMutation = useMutation({
    mutationFn: async (topic) => await seoApi.generateContentBriefs(websiteId, [topic]),
    onSuccess: () => {
      queryClient.invalidateQueries(['content-opportunities', websiteId]);
